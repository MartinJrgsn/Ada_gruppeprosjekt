...
use MicroBit;
with HAL; use HAL;
package body Ultrasonic_2 is

   trigger_pin_device : Integer;
   echo_pin_device : Integer;
   result : Distance_2_cm := 0;
   ...
   function Read return Distance_2_cm is
   ...
   function ConvertEchoToDistance (echo_time_us : Integer) return Distance_2_cm is
    temp_result : Integer;
   begin
      ...
      return Distance_2_cm(temp_result);
